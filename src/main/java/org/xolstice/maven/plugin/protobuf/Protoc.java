...
/**
 * This class represents an invokable configuration of the {@code protoc} compiler. The actual
 * executable is invoked using the plexus {@link Commandline}.
 */
final class Protoc {
  ...
  /**
   * A directory into which Objective-C source files will be generated in a J2Objc setup.
   */
  private final File j2objcOutputDirectory;
  /**
  ...
  private final MojoType mojoType;
   ...
   * @param includeImportsInDescriptorSet If {@code true}, dependencies will be included in the
   *        descriptor set.
   * @param includeSourceInfoInDescriptorSet If {@code true}, source code information will be
   ...
   */
  private Protoc(final String executable, final ImmutableSet<File> protoPath, final ImmutableSet<File> protoFiles,
      final File javaOutputDirectory, final File javaNanoOutputDirectory, final File cppOutputDirectory,
      final File pythonOutputDirectory, final File customOutputDirectory, final File j2objcOutputDirectory, final MojoType mojoType,
      final File descriptorSetFile, final boolean includeImportsInDescriptorSet, final boolean includeSourceInfoInDescriptorSet,
      final ImmutableSet<ProtocPlugin> plugins, final File pluginDirectory, final String nativePluginId,
      final String nativePluginExecutable, final String nativePluginParameter) {
    ...
    this.j2objcOutputDirectory = j2objcOutputDirectory;
  ...
  public ImmutableList<String> buildProtocCommand() {
    ...
    if ((mojoType == MojoType.J2OBJC) && (j2objcOutputDirectory != null)) {
      // Only add this when actually using the O2ObjC compiler
      command.add("--j2objc_out=" + j2objcOutputDirectory);
    }
  ...
  /**
   * Logs execution parameters on debug level to the specified logger. All log messages will be
   * prefixed with "{@value #LOG_PREFIX}".
   *
   * @param log a logger.
   */
  ...
  static final class Builder {
    ...
    /**
     * A directory into which Objective-C source files will be generated for a J2Objc setup.
     */
    private File j2objcOutputDirectory;
    ...
    public Builder setJavaNanoOutputDirectory(final File javaNanoOutputDirectory) {
      ...
      checkArgument(javaNanoOutputDirectory.isDirectory(), "'javaNanoOutputDirectory' is not a directory: " + javaNanoOutputDirectory);
      return this;
    }

    /**
     * Sets the directory into which Objective-C source files will be generated in a j2objc setup.
     *
     * @param j2objcOutputDirectory a directory into which Java source files will be generated.
     * @return this builder instance.
     * @throws NullPointerException if {@code objcOutputDirectory} is {@code null}.
     * @throws IllegalArgumentException if {@code objcOutputDirectory} is not a directory.
     */
    public Builder setJ2ObjcOutputDirectory(final File j2objcOutputDirectory) {
      this.j2objcOutputDirectory = checkNotNull(j2objcOutputDirectory, "'j2objcOutputDirectory' is null");
      checkArgument(j2objcOutputDirectory.isDirectory(), "'j2objcOutputDirectory' is not a directory: " + j2objcOutputDirectory);
      return this;
    }
     ...
     *
     * @param customOutputDirectory a directory into which a custom protoc plugin will generate
     *        files.
     * @return this builder instance.
    ...
    public Builder setCustomOutputDirectory(final File customOutputDirectory) {
      ...
      checkArgument(customOutputDirectory.isDirectory(), "'customOutputDirectory' is not a directory: " + customOutputDirectory);
      return this;
    }

    /**
     * Adds a proto file to be compiled. Proto files must be on the protopath and this method will
     * fail if a proto file is added without first adding a parent directory to the protopath.
     *
     * @param protoFile source protobuf definitions file.
     * @return The builder.
     * @throws IllegalStateException If a proto file is added without first adding a parent
    ...
    public void setNativePluginId(final String nativePluginId) {
      ...
      checkArgument(!(nativePluginId.equals("java") || nativePluginId.equals("javanano") || nativePluginId.equals("python")
          || nativePluginId.equals("cpp") || nativePluginId.equals("descriptor_set")),
     ...
     * @throws IllegalArgumentException If {@code protpathElement} is not a directory.
     */
    ...
    /**
     * 
     * @param type the MojoType
     * @return this builder instance.
     */
    public Builder setMojoType(MojoType type) {
      this.mojoType = type;
    ...
    private void validateState() {
      ...
      checkState(javaOutputDirectory != null || javaNanoOutputDirectory != null || cppOutputDirectory != null
          || pythonOutputDirectory != null || customOutputDirectory != null, "At least one of these properties must be set: "
    ...
    public Protoc build() {
      ...
      return new Protoc(executable, ImmutableSet.copyOf(protopathElements), ImmutableSet.copyOf(protoFiles), javaOutputDirectory,
          javaNanoOutputDirectory, cppOutputDirectory, pythonOutputDirectory, customOutputDirectory, j2objcOutputDirectory, mojoType,
          descriptorSetFile, includeImportsInDescriptorSet, includeSourceInfoInDescriptorSet, ImmutableSet.copyOf(plugins),
          pluginDirectory, nativePluginId, nativePluginExecutable, nativePluginParameter);
    }
  }
}
